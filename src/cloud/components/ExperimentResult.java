...
public class ExperimentResult {
	...
	public static void calculateExperimentResult(String name, List<VM> vmList, List<Workflow> workflowList, long totalScheduleTime) {
		...
		double totalResourceUtiliazation = 0; //The resource utiliazation, radio of total execute time and total lease time
		...
		//Caculate the average result into result txt when repeat times equals the max value and run the last algorithm
	...
	/**Unused,calculate the experiment result*/
	public static void calculateExperimentResultShow(String name, List<VM> vmList, List<Workflow> workflowList, long totalScheduleTime) {
		java.text.DecimalFormat formatD = new java.text.DecimalFormat("0.00000");
		...
		//Output the results
		System.out.println(name + "--Total Cost: "+formatD.format(totalCost)+" Resource Utilization: "
		+formatD.format(totalRU)+" Success Rate: "+formatD.format(totalSuccessRate)+ " Deadline Deviation: "+formatD.format(deadlineDeviation)
		+" ScheduleTime:"+formatD.format(averageScheduleTimePreTask) );
	}
